...
class TeacherGradingAPITester:
    ...
    def test_student_management(self):
        ...
        success, response = self.run_test("Create Student 2", "POST", "students", 201, student_data2)
        if success and 'id' in response:
            self.created_ids['students'].append(response['id'])
    ...
    def test_subject_management(self):
        ...
        success, response = self.run_test("Create Learning Objective", "POST", "learning-objectives", 201, objective_data)
        if success and 'id' in response:
        ...
        success, response = self.run_test("Create Learning Objective 2", "POST", "learning-objectives", 201, objective_data2)
        if success and 'id' in response:
            self.created_ids['learning_objectives'].append(response['id'])
